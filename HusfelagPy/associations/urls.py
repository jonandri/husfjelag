...
from .views import (
    ...
    SendCollectionReminderView, SendAllCollectionRemindersView,
...
urlpatterns = [
    ...
    path("Collection/<int:collection_id>/send-reminder", SendCollectionReminderView.as_view(), name="collection-send-reminder"),
    path("associations/<int:association_id>/collections/send-reminders", SendAllCollectionRemindersView.as_view(), name="collection-send-all-reminders"),
