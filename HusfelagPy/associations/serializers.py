...
class CategorySerializer(serializers.ModelSerializer):
    ...
    income_account_name = serializers.CharField(
        source="income_account.name", read_only=True, allow_null=True
    )
...
class BankAccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BankAccount
        fields = ["id", "name", "account_number", "description", "deleted", "asset_account", "current_balance", "opening_balance", "opening_balance_date"]
